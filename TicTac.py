...
root.title("Cross and Zero Rumble")
root.configure(background='Cadet Blue')

Tops = Frame(root, bg='Cadet Blue' , pady=2, width=1350, height=100, relief=RIDGE )
Tops.grid(row=0, column=0)

lblTitle= Label(Tops, font=('Times New Roman', 50, 'bold'), text="Cross and Zero Rumble", bd=21, bg='Cadet Blue', fg='Cornsilk', justify=CENTER)
...
lblPlayerX = Label(RightFrame1, font=('Times New Roman', 40, 'bold'), text="Player X:", padx=2, pady=2, bg="Cadet Blue")
lblPlayerX.grid(row=0, column=0, sticky=W)
txtPlayerX= Entry(RightFrame1, font=('Times New Roman', 40, 'bold'), bd=2, fg="black", textvariable=PlayerX, width=16, justify=LEFT).grid(row=0, column=1)

lblPlayerO = Label(RightFrame1, font=('Times New Roman', 40, 'bold'), text="Player O:", padx=2, pady=2, bg="Cadet Blue")
lblPlayerO.grid(row=1, column=0, sticky=W)
txtPlayerO= Entry(RightFrame1, font=('Times New Roman', 40, 'bold'), bd=2, fg="black", textvariable=PlayerO, width=16, justify=LEFT).grid(row=1, column=1)

btnReset= Button(RightFrame2, text=" Reset", font=('Times 26 bold'),  height=2, width=25, command=reset)
btnReset.grid(row=2, column=0, padx=6, pady=11)

btnNewGame= Button(RightFrame2, text=" New Game ", font=('Times 26 bold'),  height=2, width=25, command=NewGame)
